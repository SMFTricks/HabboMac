...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		...
		<ul class="reset f2">
			<li class="copyright">', mac_copy(), '</li>
		</ul>';
	...
	if ($context['show_load_time'])
		echo '
		<p class="load_time">', $txt['page_created'], $context['load_time'], $txt['seconds_with'], $context['load_queries'], $txt['queries'], '</p>';
	echo '
	</div>
</div>';
}
...
// Theme Copyright - HabboMac
function mac_copy()
{
	$HMCopy = 'Theme by <a href="https://smftricks.com">SMF Tricks</a>';
